...
function createMockExcel() {
    ...
    const filePath = path_1.default.join(dir, 'mock_catalog.xlsx');
...
async function runTests() {
    ...
    try {
        ...
        const signupRes = await axios_1.default.post(`${BASE_URL}/api/auth/signup`, {
            name: 'Test Salon',
        ...
        const settingsRes = await axios_1.default.put(`${BASE_URL}/api/auth/settings`, {
        ...
        form.append('file', fs_1.default.createReadStream(excelPath));
        const uploadRes = await axios_1.default.post(`${BASE_URL}/api/knowledge/upload`, form, {
            headers: {
                ...form.getHeaders(),
        ...
        const listRes = await axios_1.default.get(`${BASE_URL}/api/knowledge`, authHeaders);
        ...
        const webhookGreetingRes = await axios_1.default.post(`${BASE_URL}/api/webhook`, {
        ...
        const convRes = await axios_1.default.get(`${BASE_URL}/api/conversations`, authHeaders);
        ...
        const msgRes = await axios_1.default.get(`${BASE_URL}/api/conversations/${conversationId}/messages`, authHeaders);
        ...
        await axios_1.default.post(`${BASE_URL}/api/webhook`, {
            object: 'whatsapp_business_account',
            entry: [{
                    id: '12345',
                    changes: [{
        ...
        await new Promise(r => setTimeout(r, 1000));
        const msgRes2 = await axios_1.default.get(`${BASE_URL}/api/conversations/${conversationId}/messages`, authHeaders);
        ...
        await new Promise(r => setTimeout(r, 1000));
        const convStatusRes = await axios_1.default.get(`${BASE_URL}/api/conversations`, authHeaders);
        ...
        const billingRes = await axios_1.default.post(`${BASE_URL}/api/billing/create-subscription`, { plan: 'pro' }, authHeaders);
        ...
        const broadcastRes = await axios_1.default.post(`${BASE_URL}/api/broadcast/send`, {
        ...
        try {
            fs_1.default.rmSync(path_1.default.join(__dirname, 'temp'), { recursive: true, force: true });
        }
        catch { }
        process.exit(0);
    }
...
mongoose_1.default.connect(MONGO_URI).then(() => {
    if (mongoose_1.default.connection.db) {
        mongoose_1.default.connection.db.collection('businesses').deleteMany({ email: /test_salon/ }).then(() => {
            runTests();
        });
    }
    else {
